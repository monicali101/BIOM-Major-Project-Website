...
<head> 
        <link rel="stylesheet" type="text/css" href="SubjectsOG.css">
...
<body>
    ...
    <div>
        ...
        <a id="r" style = "margin-right: 47px" class="button" href="AddSubject.php?un=<?php echo $username?>">  Add Subject</a>
        <br><br><br><br><br>
        ...
        <?php
            ...
            while(odbc_fetch_row($registered)){ 
                ...
                if (odbc_result($registered,"Username") == $username) {
                    ...
                    if (odbc_result($registered,"ParkinsonsTrial") == true) {
                        ...
                        while(odbc_fetch_row($parkinsons)){ 
							...
							?>
								...
								<TD> 
								<a href="SubjectData.php?id=<?php echo $ID?>&un=<?php echo $username?>">View Data</a> 
								</TD>
								<TD> 
								<a href="EditSubject.php?id=<?php echo $ID?>&un=<?php echo $username?>">Edit Subject</a> 
								</TD>
								</TR> 
							<?php
							} else {
					...
					?>
					<?php
					//Check if part of Multiple Fallers Trial
					if (odbc_result($registered,"MultipleFallersTrial") == true) {
						...
						while(odbc_fetch_row($multiple)){ 
							...
							?>	
								...
								<TD>
									<?php $ID = (odbc_result($multiple,"Subject_ID"));
										echo $ID;	  
									?>
								</TD>
					...
					if (odbc_result($registered,"POWHospitalTrial") == true) {
						...
						while(odbc_fetch_row($pow)){ 
							...
							?>	
								...
								<TD>
									<?php $ID = (odbc_result($pow,"Subject_ID"));
										echo $ID;	  
									?>
								</TD>
								...
								<TD> <a href="SubjectData.php?id=<?php echo $ID ?>&un=<?php echo $username?>">View Data</a> </TD>
								<TD> 
								<a href="EditSubject.php?id=<?php echo $ID?>&un=<?php echo $username?>">Edit Subject</a> 
								</TD>
							<?php 
