...
<body>
    ...
    <?php
		...
		echo "<H1 style=\"font-size: 30pt; margin-bottom: -100px; margin-left: 30px;\"> <a id=\"r\" class=\"button\" href=\"Subjects.php\">  Back</a>Subject ";
		echo $UID;
		echo "'s Triax Data &nbsp&nbsp&nbsp&nbsp&nbsp</H1>";
